...
namespace bridge {
    ...
    Html5BridgeViewer::Html5BridgeViewer(CppJavascriptBridgeListener * listener) : Html5ApplicationViewer(), listener_(listener) {
    ...
    void Html5BridgeViewer::addJavascriptObject() {
